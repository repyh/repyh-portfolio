                    ...
                    <div className="w-full h-[70%] flex flex-col">
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col">
                                <div>
                                    <h1
                                        className={`text-7xl active:scale-90 duration-200 transition-transform w-12 inter font-bold text-transparent hover:text-white hover:cursor-pointer ${switchClick ? 'text-white' : 'text-[#51C4D3]'}`}
                                        style={{
                                ...
                                <h1 className="text-9xl font-bold inter -ml-1">I'm <span className="text-[#51C4D3]">Chris.</span></h1>
                            </div>
